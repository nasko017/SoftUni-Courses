...
namespace Stealer
{
    public class Spy
    {
        public string StealFieldInfo(string className, params string[] nameOfTheFields)
        {
            ...
            FieldInfo[] fields = classType.GetFields(BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.Instance|BindingFlags.Public);
        ...
        {
            Type classType = Type.GetType(className);
            FieldInfo[] fileds = classType.GetFields(BindingFlags.Instance | BindingFlags.Public | BindingFlags.Static);
